...
%
% w    =N-punktowe okno danych jako wektor wierszowy.
%
% N    =dlugosc okna.
% type =jedno z nastepujacych okien (tylko cztery pierwsze litery sa znaczace,
%       lub mozna uzyc liczby):
%         1)'boxcar'   2)'tapered'   3)'tent'   4)'hanning'
%         5)'hamming'  6)'blackman'  7)'kaiser' 
% beta =parametr, zwykle liczba naturalna od 4 do 9, stosowana tylko dla okna 'kaiser'.
% Patrz takze funkcje: bessel_0, fir_weights
